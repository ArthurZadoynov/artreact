import "./styles.css";
import StrelkaSvg from "../../assets/icons/strelka.svg?react";
  ...
  return (
    <section className="aboutContainer">
      ...
      <div className="infoNumbersLast">
        ...
        >
          Jelly Belly Website <StrelkaSvg />
        </a>
        <h3>Check out all endpoints</h3>
        <ul>
          <li>
            <a href="/18moduleReact/beans">
              Beans <StrelkaSvg />
            </a>
          </li>
          <li>
            <a href="/18moduleReact/recipes">
              Recipes <StrelkaSvg />
            </a>
          </li>
          <li>
            <a href="/18moduleReact/facts">
              Facts <StrelkaSvg />
            </a>
          </li>
          <li>
            <a href="/18moduleReact/combinations">
              Combinations <StrelkaSvg />
            </a>
          </li>
          <li>
            <a href="/18moduleReact/history">
              History <StrelkaSvg />
            </a>
          </li>
        </ul>
